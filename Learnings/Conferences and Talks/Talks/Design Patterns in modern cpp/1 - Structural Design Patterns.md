...
- Graphical element on a form
	- Button can handle it, stops further processing
	- Underlying groupbox
	- Underlying window
...
- How to apply the modifiers?
	- Virtual function void handle
	- Default behavior is to call handle on the next
![Enter image alt description](Images/F9t_Image_58.png)

- Lets start with a `DoubleAttackModifier`
![Enter image alt description](Images/zzQ_Image_59.png)

- Another Modifier: `IncreaseDefenceModifier`
![Enter image alt description](Images/76z_Image_60.png)

- Start using them
- Root modifier is the base `Modifier` type
![Enter image alt description](Images/QSq_Image_61.png)